...
<br />
def recover_with_associations!(*associations)<br />
  self.recover!<br />
  associations.to_a.each do |assoc|<br />
    self.send(assoc).find_with_deleted(:all).each do |a|<br />
      a.recover! if a.class.paranoid?<br />
    end<br />
  end<br />
end</code>
